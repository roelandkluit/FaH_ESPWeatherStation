...
const char HTTP_HEAD_START[]       = "<!DOCTYPE html>"
"<html lang='en'><head>"
...
const char HTTP_SCRIPT[]           = "<script>function c(l){"
...
const char HTTP_HEAD_END[]         = "</head><body class='{c}'><div class='wrap'>"; // {c} = _bodyclass
// example of embedded logo, base64 encoded inline, No styling here
// const char HTTP_ROOT_MAIN[]        = "<img title=' alt=' src='data:image/png;base64,' /><h1>{v}</h1><h3>WiFiManager</h3>";
...
const char HTTP_HELP[]             =
 ...
 "<p/>Github <a href='https://github.com/roelandkluit/Fah_ESPWeatherStation'>https://github.com/roelandkluit/Fah_ESPWeatherStation</a>.";
#else
const char HTTP_HELP[]             = "";
#endif

const char HTTP_UPDATE[] = "Upload new firmware<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Update</button></form><small><a href='http://192.168.4.1/update' target='_blank'>* May not function inside captive portal, open in browser http://192.168.4.1</a><small>";
...
#else
	const char HTTP_INFO_esphead[]    = "<h3>esp8266</h3><hr><dl>";
	const char HTTP_INFO_fchipid[]    = "<dt>Flash chip ID</dt><dd>{1}</dd>";
	const char HTTP_INFO_corever[]    = "<dt>Core version</dt><dd>{1}</dd>";
	const char HTTP_INFO_bootver[]    = "<dt>Boot version</dt><dd>{1}</dd>";
	const char HTTP_INFO_lastreset[]  = "<dt>Last reset reason</dt><dd>{1}</dd>";
	const char HTTP_INFO_flashsize[]  = "<dt>Real flash size</dt><dd>{1} bytes</dd>";
#endif
...
const char HTTP_INFO_stasig[]    = "<dt>Signal level</dt><dd>{1}</dd>";
...
const char HTTP_INFO_aboutver[]     = "<dt>WiFiManager</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutarduino[] = "<dt>Arduino</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutFahConnect[] = "<dt>FreeAtHome Integration</dt><dd>{2}</dd>";
const char HTTP_INFO_aboutsdk[]     = "<dt>ESP-SDK/IDF</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutdate[]    = "<dt>Build date</dt><dd>{1}</dd>";

const char S_brand[]              = "WiFiManager - WeatherStation";
const char S_debugPrefix[]        = "*wm:";
const char S_y[]                  = "Yes";
const char S_n[]                  = "No";
...
#ifdef ESP8266
    const char S_ssidpre[]        = "ESP";
#elif defined(ESP32)
    const char S_ssidpre[]        = "ESP32";
#else
    const char S_ssidpre[]        = "WM";
#endif
